define(["react@17.0.2","scheduler@0.20.2"], (dep_0, dep_1) => {

const dependencies = new Map([['react@17.0.2', dep_0],['scheduler@0.20.2', dep_1]]);
  ...
  "node_modules/react-dom/cjs/react-dom.development.js"(exports) {
    ...
    if (true) {
      (function () {
        ...
        var React = require("react@17.0.2");

        var _assign = require_object_assign();

        var Scheduler = require("scheduler@0.20.2");
...
__export(react_dom_17_0_2_exports, {
  default: () => react_dom_17_0_2_default
});

__reExport(react_dom_17_0_2_exports, __toESM(require_react_dom()));

var import_react_dom = __toESM(require_react_dom());

var react_dom_17_0_2_default = import_react_dom.default;
module.exports = __toCommonJS(react_dom_17_0_2_exports);
/*
object-assign
(c) Sindre Sorhus
@license MIT
