System.register(["@beyond-js/kernel@0.1.0/bundle","@beyond-js/kernel@0.1.0/core","@beyond-js/widgets@0.1.0/render","@beyond-js/kernel@0.1.0/styles"], (_exports, _context) => {

const bimport = specifier => {
	const dependencies = new Map([["@beyond-js/kernel","0.1.0"],["@beyond-js/widgets","0.1.0"]]);
...
return {
setters: [dep => dependencies.set('@beyond-js/kernel@0.1.0/bundle', dep), dep => dependencies.set('@beyond-js/kernel@0.1.0/core', dep), dep => dependencies.set('@beyond-js/widgets@0.1.0/render', dep), dep => dependencies.set('@beyond-js/kernel@0.1.0/styles', dep)],
execute: function() {
...
// .beyond/uimport/@beyond-js/widgets/controller.0.1.0.js
...
var dependency_3 = __toESM(require("@beyond-js/kernel@0.1.0/styles"), 0);
var import_meta = {};
var {
  Bundle: __Bundle
} = dependency_0;
