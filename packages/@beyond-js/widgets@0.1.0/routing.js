System.register(["@beyond-js/kernel@0.1.0/bundle","@beyond-js/kernel@0.1.0/core","@beyond-js/widgets@0.1.0/render","@beyond-js/kernel@0.1.0/routing"], (_exports, _context) => {
...
return {
setters: [dep => dependencies.set('@beyond-js/kernel@0.1.0/bundle', dep), dep => dependencies.set('@beyond-js/kernel@0.1.0/core', dep), dep => dependencies.set('@beyond-js/widgets@0.1.0/render', dep), dep => dependencies.set('@beyond-js/kernel@0.1.0/routing', dep)],
execute: function() {
...
// .beyond/uimport/@beyond-js/widgets/routing.0.1.0.js
...
var dependency_3 = __toESM(require("@beyond-js/kernel@0.1.0/routing"), 0);
var import_meta = {};
var {
  Bundle: __Bundle
} = dependency_0;
