System.register(["@beyond-js/kernel@0.1.0/bundle","react@18.2.0","scheduler@0.23.0","react-dom@18.2.0","react-dom@18.2.0/client","@beyond-js/kernel@0.1.0/core","@beyond-js/widgets@0.1.0/render","@beyond-js/kernel@0.1.0/styles","@beyond-js/widgets@0.1.0/controller","@beyond-js/react-widgets@18.20.1/base","@beyond-js/kernel@0.1.0/routing","@beyond-js/widgets@0.1.0/routing"], (_exports, _context) => {

const bimport = specifier => {
	const dependencies = new Map([["@beyond-js/kernel","0.1.0"],["react","18.2.0"],["scheduler","0.23.0"],["react-dom","18.2.0"],["@beyond-js/widgets","0.1.0"],["@beyond-js/react-widgets","18.20.1"]]);
...
return {
setters: [dep => dependencies.set('@beyond-js/kernel@0.1.0/bundle', dep), dep => dependencies.set('react@18.2.0', dep), dep => dependencies.set('scheduler@0.23.0', dep), dep => dependencies.set('react-dom@18.2.0', dep), dep => dependencies.set('react-dom@18.2.0/client', dep), dep => dependencies.set('@beyond-js/kernel@0.1.0/core', dep), dep => dependencies.set('@beyond-js/widgets@0.1.0/render', dep), dep => dependencies.set('@beyond-js/kernel@0.1.0/styles', dep), dep => dependencies.set('@beyond-js/widgets@0.1.0/controller', dep), dep => dependencies.set('@beyond-js/react-widgets@18.20.1/base', dep), dep => dependencies.set('@beyond-js/kernel@0.1.0/routing', dep), dep => dependencies.set('@beyond-js/widgets@0.1.0/routing', dep)],
execute: function() {
...
// .beyond/uimport/@beyond-js/react-widgets/page.18.20.1.js
