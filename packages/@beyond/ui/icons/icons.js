define(["exports", "@beyond-js/kernel/bundle", "react", "@beyond-js/kernel/routing", "prop-types", "@beyond-js/kernel/styles"], function (_exports, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4) {
  "use strict";
  ...
  ;
  externals.register(new Map([["@beyond-js/kernel/bundle", dependency_0], ["react", dependency_1], ["@beyond-js/kernel/routing", dependency_2], ["prop-types", dependency_3], ["@beyond-js/kernel/styles", dependency_4]]));

  require('@beyond-js/kernel/styles').styles.register('@beyond/ui/icons');
