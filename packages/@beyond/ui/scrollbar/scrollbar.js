define(["exports", "@beyond-js/kernel/bundle", "@beyond-js/kernel/styles", "react", "perfect-scrollbar"], function (_exports, dependency_0, dependency_1, dependency_2, dependency_3) {
  "use strict";
  ...
  ;
  externals.register(new Map([["@beyond-js/kernel/bundle", dependency_0], ["@beyond-js/kernel/styles", dependency_1], ["react", dependency_2], ["perfect-scrollbar", dependency_3]]));

  require('@beyond-js/kernel/styles').styles.register('@beyond/ui/scrollbar');
