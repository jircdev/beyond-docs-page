define(["@vue/shared@3.2.37","@vue/reactivity@3.2.37"], (dep_0, dep_1) => {

const dependencies = new Map([['@vue/shared@3.2.37', dep_0],['@vue/reactivity@3.2.37', dep_1]]);
...
})(typeof WeakMap !== "undefined" ? /* @__PURE__ */new WeakMap() : 0); // .beyond/uimport/temp/@vue/runtime-core.3.2.37.js


var runtime_core_3_2_37_exports = {};

__export(runtime_core_3_2_37_exports, {
...
var import_reactivity = require("@vue/reactivity@3.2.37");

var import_reactivity2 = require("@vue/reactivity@3.2.37");

var import_shared = require("@vue/shared@3.2.37");

var import_shared2 = require("@vue/shared@3.2.37");
...
function emit$1(instance, event, ...rawArgs) {
  ...
  if (modelArg && modelArg in props) {
    ...
    if (number) {
      args = rawArgs.map(import_shared.toNumber);
    }
  }
...
function createSuspenseBoundary(vnode, parent, parentComponent, container, hiddenContainer, anchor, isSVG, slotScopeIds, optimized, rendererInternals, isHydrating = false) {
  ...
  const timeout = (0, import_shared.toNumber)(vnode.props && vnode.props.timeout);
  const suspense = {
    vnode,
    parent,
    parentComponent,
...
function toHandlers(obj) {
  ...
  for (const key in obj) {
    ret[(0, import_shared.toHandlerKey)(key)] = obj[key];
  }
...
var PublicInstanceProxyHandlers = {
  get({
    ...
    if (setupState !== import_shared.EMPTY_OBJ && setupState.__isScriptSetup && (0, import_shared.hasOwn)(setupState, key)) {
    ...
    if (key[0] !== "$") {
      ...
      } else if (setupState !== import_shared.EMPTY_OBJ && (0, import_shared.hasOwn)(setupState, key)) {
        accessCache[key] = 1;
        return setupState[key];
  ...
  set({
    ...
    if (setupState !== import_shared.EMPTY_OBJ && (0, import_shared.hasOwn)(setupState, key)) {
  ...
  has({
    ...
    let normalizedProps;
    return !!accessCache[key] || data !== import_shared.EMPTY_OBJ && (0, import_shared.hasOwn)(data, key) || setupState !== import_shared.EMPTY_OBJ && (0, import_shared.hasOwn)(setupState, key) || (normalizedProps = propsOptions[0]) && (0, import_shared.hasOwn)(normalizedProps, key) || (0, import_shared.hasOwn)(ctx, key) || (0, import_shared.hasOwn)(publicPropertiesMap, key) || (0, import_shared.hasOwn)(appContext.config.globalProperties, key);
  },
...
module.exports = __toCommonJS(runtime_core_3_2_37_exports);
};
