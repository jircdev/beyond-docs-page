System.register(["@pksilen/reactive-js@0.1.2","react@18.2.0"], (_exports, _context) => {

const bimport = specifier => {
	const dependencies = new Map([["@pksilen/reactive-js","0.1.2"],["react","18.2.0"],["svelte","3.52.0"],["universal-model-ng-react-svelte-vue","0.3.3"],["lodash","4.17.21"]]);
...
return {
setters: [dep => dependencies.set('@pksilen/reactive-js@0.1.2', dep), dep => dependencies.set('react@18.2.0', dep)],
execute: function() {
...
`;
    ...
    var boolean_attributes = /* @__PURE__ */new Set(["allowfullscreen", "allowpaymentrequest", "async", "autofocus", "autoplay", "checked", "controls", "default", "defer", "disabled", "formnovalidate", "hidden", "inert", "ismap", "itemscope", "loop", "multiple", "muted", "nomodule", "novalidate", "open", "playsinline", "readonly", "required", "reversed", "selected"]);
...
var require_Store = __commonJS({
  "node_modules/universal-model-ng-react-svelte-vue/lib/Store.js"(exports) {
    ...
    var _react = require("react@18.2.0");
