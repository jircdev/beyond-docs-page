define(["exports", "@beyond-js/kernel/styles/ts", "@beyond-js/kernel/bundle/ts"], function (_exports, dependency_0, dependency_1) {
  ...
  const __pkg = new __Bundle("@beyond/docs/docs/basic/projecs/code").package();

  externals.register(new Map([]));

  require('@beyond-js/kernel/styles/ts').styles.register('@beyond/docs/docs/basic/projecs/code');
