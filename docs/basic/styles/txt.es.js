define(["exports"], function (_exports) {
  ...
  const __pkg = new __Bundle("@beyond/docs/docs/basic/styles/txt").package('es');
    ...
    creator: function (require, exports) {
      exports.txt = {
        ...
        "templateApplication": {
          ...
          "p1": {
            "t1": "La propiedad application representa al archivo styles.css incluido en los proyectos con plataforma web. Está contemplada para agregar algún estilo general del documento y la definición de ",
            "e1": {
              "href": "https://developer.mozilla.org/en-US/docs/Web/CSS/--*",
              "label": "propiedades personalizadas"
            },
            "t2": "para que esten disponibles en todos los widgets."
          },
        ...
        "StylesInTheModule": {
          "t1": "Estilos en el módulo",
          "p1": {
            "t1": "Para agregar estilos en un módulo/bundle creado, debe agregarse el ",
            "e1": {
              "href": "/processors",
              "label": "procesador"
            },
          ...
          "p2": "Si se usa el dashboard para la creación de proyectos, el procesador sass es incluido por defecto en los bundles de tipo code y widget de cualquier tipo.",
        ...
        "importOfStyleFiles": {
          "t1": "Importación de archivos de estilo",
          "t2": "Node Modules",
        ...
        "importingStylesFromABundle": {
          "t1": "Importación de estilos de un bundle",
