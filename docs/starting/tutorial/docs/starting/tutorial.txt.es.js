    ...
    creator: function (require, exports) {
      exports.txt = {
        ...
        "firstModule": {
          ...
          "p01": "En el dashboard, tambien podemos hacer click sobre el proyecto y esto abrirá un nuevo tab con el listado de módulos del mismo.",
          "i1": ["/images/tutorial/project-view.png", "BeyondJS - Project view"],
          "p0": "Como puede verse, el proyecto trae dos módulos creados, el Home, que responde a la url base del proyecto y el modulo “server-start” del cúal se hablará más adelante.",
          "p1": "Desde el Dashboard tambien podemos ver el contenido de estos módulos, para ello podemos hacer click en el icono de proyecto en el PreAside y luego seleccionar el módulo que deseemos y podremos ver la estructura del mismo.",
          ...
          "items1": ["Ver los bundles de un modulo.", "Ver los archivos de los bundles.", "Agregar archivos.", "Editar el código fuente de los archivos.", "Generar declaraciones.", "Visualizar errores de código."],
        ...
        "formCreation": {
          ...
          "p2": " La edición puede hacerse desde tu IDE de preferencia y tambien desde el Editor integrado del Dashboard, el cual tiene como finalidad brindar ayuda para casos especificos al desarrollador, pero para efectos del tutorial recomendamos usarlo, basta con hacer click en el archivo requerido desde el aside.",
          "c1": "page"
        },
        "styles": {
          "h2": "Estilos",
        ...
        "backendLogic": {
          ...
          "p2": "Para realizar la integración cliente/servidor, es necesario crear un bundle de tipo BRIDGE, que cómo su nombre indica, nos permitirá integrar la lógica entre ellos. Para crearlo, haremos uso del formulario de creación de módulos del Dashboard, que se puede acceder desde el icono de + en el Aside."
        },
        "backendInitialization": {
          ...
          "p6": "El bundle Bridge, lo crearemos desde el formulario de creación de módulos del Dashboard, al cual se puede acceder desde el icono + en el Aside. Aparecerá un formulario como el siguiente: ",
