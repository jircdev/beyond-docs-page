define(["exports", "@beyond-js/kernel/styles/ts", "@beyond-js/kernel/bundle/ts"], function (_exports2, dependency_0, dependency_1) {
  ...
  const __pkg = new __Bundle("@beyond/docs/docs/fundations/hmr/code").package();

  externals.register(new Map([]));

  require('@beyond-js/kernel/styles/ts').styles.register('@beyond/docs/docs/fundations/hmr/code');
