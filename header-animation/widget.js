define(["exports", "@beyond-js/widgets/render/ts", "@beyond-js/kernel/styles/ts", "svelte/internal", "@beyond-js/svelte-widgets/controllers/code", "svelte", "@beyond-js/kernel/bundle/ts"], function (_exports2, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5) {
  "use strict";
  ...
  ****************************/
  ...
  ims.set('./controller', {
    ...
    creator: function (require, exports) {
      ...
      var _code = require("@beyond-js/svelte-widgets/controllers/code");

      var _widget = require("./widget.svelte");
      /*bundle*/


      class Controller extends _code.SvelteWidgetController {
        get Widget() {
