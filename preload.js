define(["exports", "@beyond-js/kernel/bundle", "react", "@beyond/docs/ui/icons"], function (_exports, dependency_0, dependency_1, dependency_2) {
  "use strict";
  ...
  *************************/
  ...
  let BeyondIsotype, PreloadPage; // Module exports

  _exports.PreloadPage = PreloadPage;
  _exports.BeyondIsotype = BeyondIsotype;
  ...
  __pkg.exports.process = function ({
    ...
    (require || prop === 'BeyondIsotype') && (_exports.BeyondIsotype = BeyondIsotype = require ? require('./icon').BeyondIsotype : value);
    (require || prop === 'PreloadPage') && (_exports.PreloadPage = PreloadPage = require ? require('./loading').PreloadPage : value);
  };
