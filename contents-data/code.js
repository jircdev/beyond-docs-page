define(["exports", "react", "@beyond/docs/components/next-links/code", "@beyond/docs/components/html/code", "@beyond/ui/link/code", "@beyond/docs/code/code", "@beyond-js/kernel/core/ts", "@beyond-js/react-widgets/controllers/ts", "@beyond/docs/docs/starting/intro/code", "@beyond/docs/docs/starting/quick-start/code", "@beyond/docs/docs/foundations/dev-server/code", "@beyond/docs/docs/starting/tutorial/code", "@beyond/docs/docs/starting/dashboard/code", "@beyond/docs/docs/basic/projects/code", "@beyond/docs/docs/basic/modules/code", "@beyond/docs/docs/basic/bundles/code", "@beyond/docs/docs/basic/widgets/intro/code", "@beyond/docs/docs/basic/widgets/rendering/code", "@beyond/docs/docs/basic/backend/code", "@beyond/docs/docs/basic/routing/code", "@beyond/docs/docs/basic/styles/code", "@beyond/docs/docs/basic/state/code", "@beyond/docs/docs/basic/processors/code", "@beyond/docs/docs/foundations/bee/code", "@beyond/docs/docs/foundations/hmr/code", "@beyond/docs/docs/foundations/distributions/code", "@beyond/docs/ui/icons/code", "@beyond-js/kernel/texts/ts", "@beyond/ui/image/code", "@beyond-js/kernel/bundle/ts", "@beyond-js/kernel/styles/ts"], function (_exports, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, dependency_8, dependency_9, dependency_10, dependency_11, dependency_12, dependency_13, dependency_14, dependency_15, dependency_16, dependency_17, dependency_18, dependency_19, dependency_20, dependency_21, dependency_22, dependency_23, dependency_24, dependency_25, dependency_26, dependency_27, dependency_28, dependency_29) {
  "use strict";
  ...
  __pkg.dependencies.update(new Set(["@beyond/docs/components/next-links/code", "@beyond/docs/components/html/code", "@beyond/ui/link/code", "@beyond/docs/code/code", "@beyond/docs/docs/starting/intro/code", "@beyond/docs/docs/starting/quick-start/code", "@beyond/docs/docs/foundations/dev-server/code", "@beyond/docs/docs/starting/tutorial/code", "@beyond/docs/docs/starting/dashboard/code", "@beyond/docs/docs/basic/projects/code", "@beyond/docs/docs/basic/modules/code", "@beyond/docs/docs/basic/bundles/code", "@beyond/docs/docs/basic/widgets/intro/code", "@beyond/docs/docs/basic/widgets/rendering/code", "@beyond/docs/docs/basic/backend/code", "@beyond/docs/docs/basic/routing/code", "@beyond/docs/docs/basic/styles/code", "@beyond/docs/docs/basic/state/code", "@beyond/docs/docs/basic/processors/code", "@beyond/docs/docs/foundations/bee/code", "@beyond/docs/docs/foundations/hmr/code", "@beyond/docs/docs/foundations/distributions/code", "@beyond/docs/ui/icons/code", "@beyond/ui/image/code"]));
  ...
  ********************/
  ...
  ims.set('./db', {
    ...
    creator: function (require, exports) {
      ...
      var _code = require("@beyond/docs/docs/starting/intro/code");

      var _code2 = require("@beyond/docs/docs/starting/quick-start/code");

      var _code3 = require("@beyond/docs/docs/foundations/dev-server/code");

      var _code4 = require("@beyond/docs/docs/starting/tutorial/code");

      var _code5 = require("@beyond/docs/docs/starting/dashboard/code");

      var _code6 = require("@beyond/docs/docs/basic/projects/code");

      var _code7 = require("@beyond/docs/docs/basic/modules/code");

      var _code8 = require("@beyond/docs/docs/basic/bundles/code");

      var _code9 = require("@beyond/docs/docs/basic/widgets/intro/code");

      var _code10 = require("@beyond/docs/docs/basic/widgets/rendering/code");

      var _code11 = require("@beyond/docs/docs/basic/backend/code");

      var _code12 = require("@beyond/docs/docs/basic/routing/code");

      var _code13 = require("@beyond/docs/docs/basic/styles/code");

      var _code14 = require("@beyond/docs/docs/basic/state/code");

      var _code15 = require("@beyond/docs/docs/basic/processors/code");

      var _code16 = require("@beyond/docs/docs/foundations/bee/code");

      var _code17 = require("@beyond/docs/docs/foundations/hmr/code");

      var _code18 = require("@beyond/docs/docs/foundations/distributions/code");
      ...
      const getContent = (contentId, sub = undefined) => {
        const starting = {
          intro: _code.DocsIntro,
          'quick-start': _code2.QuickStart,
          dashboard: _code5.DashboardPage,
          tutorial: {
            start: _code4.TutorialIntro,
            'first-module': _code4.TutorialFirstModule,
            backend: _code4.TutorialBackend,
            bridge: _code4.TutorialBridge,
            routing: _code4.TutorialRouting
          }
        };
        const basics = {
          projects: {
            intro: _code6.ProjectsIntro,
            create: _code6.ProjectCreate,
            structure: _code6.ProjectStructure,
            json: _code6.ProjectJson,
            import: _code6.ProjectImports,
            dependencies: _code6.ProjectDependencies
          },
          modules: {
            introduction: _code7.ModulesIntro,
            create: _code7.ModulesCreate,
            json: _code7.ModulesConfig
          },
          ...
          styles: {
            template: _code13.StylesTemplatePage,
            modules: _code13.StylesModulesPage,
            imports: _code13.StylesImportsPage,
        ...
        const foundations = {
          ...
          'dev-server': _code3.DevServer,
          // glossary: Glossary,
          foundations: {
            bee: _code16.BEEPage,
            hmr: _code17.HMRPage,
            distributions: _code18.DistributionsPage
