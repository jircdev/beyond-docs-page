define(["exports", "@beyond-js/kernel/react-widget/ts", "@beyond-js/kernel/core/ts", "@beyond/docs/layout/styles/code", "react", "@beyond-js/kernel/routing/ts", "@beyond/docs/ui/icons/code", "@beyond/docs/manager/code", "@beyond/docs/store/code", "@beyond/ui/icons/code", "@beyond/ui/image/code"], function (_exports2, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, dependency_8, dependency_9) {
  ...
  **********/
  ...
  bundle.styles.value = '.flex-center{place-content:center;place-items:center;display:flex;gap:15px}.flex-center-y{display:flex;align-items:center;align-content:center;gap:15px}.flex-center-x{display:flex;justify-content:center;gap:15px}.f-container,.flex-container{display:flex}.f-container.f-space-between,.f-container.space-between,.flex-container.f-space-between,.flex-container.space-between{justify-content:space-between}.f-container.gap-5,.flex-container.gap-5{gap:5px}.f-container.gap-10,.flex-container.gap-10{gap:10px}.f-container.gap-15,.flex-container.gap-15{gap:15px}.f-container.gap-30,.flex-container.gap-30{gap:30px}.pd-15{padding:15px}.line-border-b{border-bottom:1px solid var(--primary-accent)}.aside__header{display:flex;position:relative;flex-direction:column;border-bottom:1px solid var(--separator-color);align-content:center;margin-bottom:1rem}.aside__header .menu-docs__mobile-header{display:none}.aside__header .img-logo{margin:0;width:50%;justify-content:left}.aside__header .img-logo img{width:100%;height:30px;object-fit:contain;object-position:left}.aside__header h4{display:block;margin:0;padding:0}.aside__header .mobile-only{display:none;content:"max-width: 480px"}@media (max-width:480px){.aside__header .mobile-only{display:flex}}.aside__header .docs__menu__list__btn-close{position:absolute;right:15px;height:30px;width:30px;background:0 0;content:"min-width: 1025px"}.aside__header .docs__menu__list__btn-close svg{fill:var(--primary-accent)}@media (min-width:1025px){.aside__header .docs__menu__list__btn-close{display:none}}.docs__menu__list>li,.docs__menu__sublist>li{display:grid;cursor:pointer;align-items:center}.docs__menu__list>li section:hover span,.docs__menu__sublist>li section:hover span{color:var(--primary-accent)}.docs__menu__list>li>section,.docs__menu__sublist>li>section{display:flex;gap:5px;align-items:center;accent-color:var(--text-second-color);transition:.3s all ease-in;padding:4px 0}.docs__menu__list>li>section .beyond-icon,.docs__menu__sublist>li>section .beyond-icon{fill:var(--text-color)}.docs__menu__list>li.item--opened .beyond-icon,.docs__menu__sublist>li.item--opened .beyond-icon{transform:rotate(90deg)}.docs__menu__list li>ul,.docs__menu__sublist li>ul{display:none}.docs__menu__list li.item--opened>ul,.docs__menu__sublist li.item--opened>ul{list-style:none;padding:0;display:grid;grid-gap:5px;border-left:1px solid var(--color-gray-20);margin-left:15px}.docs__menu__list li.item--opened>ul li,.docs__menu__sublist li.item--opened>ul li{padding-left:15px;margin-left:-1px}.docs__menu__list li.item--opened>ul li.active-item,.docs__menu__sublist li.item--opened>ul li.active-item{border-left:2px solid var(--text-hover-color)}aside.docs__menu{flex-direction:column;content:"max-width: 768px";border-radius:4px;z-index:12;position:sticky;top:65px;border-right:1px solid var(--element-border-color)}@media (max-width:768px){aside.docs__menu{padding:15px}}aside.docs__menu *{font-size:.85rem}aside.docs__menu *{color:rgba(var(--text-color),.9)}aside.docs__menu .docs__menu__list{--item-border:var(--primary);display:grid;grid-gap:5px;list-style:none;padding:0;margin:0;position:sticky;top:0}aside.docs__menu{content:"max-width: 1200px"}@media (max-width:1200px){aside.docs__menu{position:fixed;left:0;width:0;bottom:0;top:0;transition:150ms ease-in all;overflow:hidden;padding:0;z-index:101;content:"max-width: 480px"}aside.docs__menu .menu-mobile-container{background:var(--background);height:100%;width:40%}}@media (max-width:1200px) and (max-width:480px){aside.docs__menu .menu-mobile-container{width:80%}}@media (max-width:1200px){aside.docs__menu.docs__menu--opened{width:100%;background:rgba(0,0,0,.7)}aside.docs__menu.docs__menu--opened .beyond-perfect-scrollbar{width:80%;height:100%}aside.docs__menu .menu-docs__mobile-header{display:flex;place-items:center;justify-content:space-between;gap:15px}aside.docs__menu .menu-docs__mobile-header .img-logo{height:20px;margin-top:2px}}';
